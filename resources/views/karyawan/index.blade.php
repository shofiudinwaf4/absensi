                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#modal-simple" id="btnTambahkaryawan">
                                        ...
                                        <tbody>
                                            @foreach ($karyawan as $k)
                                                @php
                                                    ...
                                                    $path = asset('storage/public/uploads/karyawan/' . $k->foto);
                                                @endphp
                                                <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="#" class="edit btn btn-info btn-sm"
                                                        nik="{{ $k->nik }}"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <a href="/konfigurasi/{{ $k->nik }}/setjamkerja"
                                                    ...
                                                    <form method="POST" action="/karyawan/{{ $k->nik }}/delete"
                                ...
                                <select name="kode_dept" id="kode_dept" class="form-select">
                                    ...
                                    @foreach ($departemen as $d)
                                        <option value="{{ $d->kode_dept }}"
                                            {{ Request('kode_dept') == $d->kode_dept ? 'select' : '' }}>
                                            {{ $d->nama_dept }}</option>
                                    @endforeach
                                </select>
                            </div>
